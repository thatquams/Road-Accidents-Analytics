...
MODEL_PATH = os.path.join(BASE_DIR, "utils/data/svc_best_model.pkl")
STATE_ENCODER_PATH = os.path.join(BASE_DIR, "utils/data/state_encoders.pkl")
SCALER_PATH = os.path.join(BASE_DIR, "utils/data/feature_scaler.pkl")
